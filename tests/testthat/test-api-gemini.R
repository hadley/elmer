test_that("can make simple request", {
  chat <- new_chat_gemini("Be as terse as possible; no punctuation")
...
test_that("can make a simple tool call", {
  ...
  chat <- new_chat_gemini(system_prompt = "Be very terse, not even punctuation.")
