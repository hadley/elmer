...
(I suspect that in general you'll get a mix of styles depending on what problem you apply the prompt to, so if you do want tidyverse code, I'd recommend that you be explicit about it.)
