...
Prompt engineering is the art of writing a prompt that reliably gets you the result that you want. It's an evolving skill because as LLMs evolve the techniques needed to get results will also change. So expect to keep learning.

We'll focus on prompt engineering in the system prompt, but most of the advice applies regardless of it's a system prompt or user queries.
